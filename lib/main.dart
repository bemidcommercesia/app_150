...
Future<void> main() async {
    ...
    await PushAlertsNs2kd7py.init(
      PushAlertsNs2kd7pyConfig(
        ...
        behaviour: PushAlertsNs2kd7pyNavigationBehaviour(
          onForm: () => AppNavigationNs2kd7py.goNamed(.form),
        ),
      ),
    );
  ...
  await FeedbackPopupns2kd7py.init(
    settings: FeedbackPopupns2kd7pySettings(
      ...
      onHome: (context) {
        AppNavigationNs2kd7py.replaceNamed(.home);
      },
      onOnboarding: (context) {
        AppNavigationNs2kd7py.replaceNamed(.intro);
      },
      storeRatingBehaviour: FeedbackPopupns2kd7pyStoreRatingBehaviour.redirect,
